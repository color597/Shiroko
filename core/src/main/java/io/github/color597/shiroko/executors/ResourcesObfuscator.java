...
import io.github.color597.shiroko.bundle.AppBundleUtils;
import io.github.color597.shiroko.bundle.ResourcesTableBuilder;
import io.github.color597.shiroko.bundle.ResourcesTableOperation;
import io.github.color597.shiroko.model.ResourcesMapping;
import io.github.color597.shiroko.obfuscation.ResGuardStringBuilder;
import io.github.color597.shiroko.parser.ResourcesMappingParser;
import io.github.color597.shiroko.utils.FileOperation;
import io.github.color597.shiroko.utils.TimeClock;
import io.github.color597.shiroko.utils.Utils;
...
import static io.github.color597.shiroko.bundle.AppBundleUtils.getEntryNameByResourceName;
import static io.github.color597.shiroko.bundle.AppBundleUtils.getTypeNameByResourceName;
import static io.github.color597.shiroko.bundle.ResourcesTableOperation.checkConfiguration;
import static io.github.color597.shiroko.bundle.ResourcesTableOperation.updateEntryConfigValueList;
import static io.github.color597.shiroko.utils.FileOperation.getFilePrefixByFileName;
import static io.github.color597.shiroko.utils.FileOperation.getNameFromZipFilePath;
import static io.github.color597.shiroko.utils.FileOperation.getParentFromZipFilePath;
...
public class ResourcesObfuscator {
    ...
    private boolean shouldBeObfuscated(String resourceName) {
        ...
        for (String rule : whiteListRules) {
            System.out.println("Rule: " + rule + ", resourceName: " + resourceName);
